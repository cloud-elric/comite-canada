...
<?php echo CHtml::hiddenField("return", "https://qa.2geeksonemonkey.com/global_judging/canada/community/usrUsuarios/revisarPago")?>
<?php echo CHtml::hiddenField("custom", $custom)?>
<?php echo CHtml::hiddenField("notify_url", "https://qa.2geeksonemonkey.com/global_judging/canada/community/usrUsuarios/iPNPayPal")?>
